    ...
    <body>
        ...
        <div id="container">
            ...
            <section id="about-us">
                <h2>Meet the Team</h2>
                <p>
                    Get to know the amazing individuals behind this creation. We are a group of individuals studying at NSBM Green University, following the Software Engineering degree program. If you have any complaints, suggestions, and innovative ideas, please contact us through our contact us page.
                </p>
            </section>
        </div>
    </body>
