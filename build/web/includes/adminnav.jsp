...
<nav class="navbar navbar-expand-lg bg-dark" style="background-color: #333; padding: 15px;">
    <div class="container-fluid">
        <a class="navbar-brand" href="#" style="color: white; font-size: 24px;">
            <img src="images/FreshStop.png" width="50" height="50" alt="alt" class="mr-2"/> FreshStop
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="login_1.jsp" style="color: white; font-size: 18px;">Logout</a>
                </li>
            </ul>
        </div>
    </div>
